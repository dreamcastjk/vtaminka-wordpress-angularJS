...
ajaxApi::registerApiAction('getProductListAction'); //вывод товаров на главную страницу
ajaxApi::registerApiAction('getCategoryListAction'); //вывод категорий товаров на главную страницу
ajaxApi::registerApiAction('getProductsByCategoryAction'); //вывод товаров пока категории
ajaxApi::registerApiAction('purchaseOrderAction'); // оформление заказа
